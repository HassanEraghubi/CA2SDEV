...
def cart_detail(request, total=0, counter=0, cart_items = None):
  ...
  description = 'Online Shop - Order Now'
  ...
  if request.method == 'POST':
    ...
    try: 
      ...
      return e 
  return render(request, 'cart.html', {'cart_items':cart_items, 'total':total, 'counter':counter, 'stripe_total':stripe_total, 
                                       'description':description, 'data_key':data_key,
